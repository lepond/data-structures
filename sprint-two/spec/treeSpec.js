describe('tree', function() {
  ...
  it('should add children to the tree with proper parenting relationship', function() {
    tree.addChild(5);
    expect(tree.children[0].parent.value).to.equal(6);
  });

  it('should delete connection both ways when removing parent', function() {
    tree.addChild(5);
